...
\begin{figure}[t] 
\centering 
\subfigure[Movement from P-EGW1 to P-GEW2]{
	\includegraphics[width=0.48\linewidth, trim=0cm 0cm 0cm 0cm]{./figures/fig2(a).pdf}}
\subfigure[Movement from P-EGW2 to P-GEW3]{
	\includegraphics[width=0.48\linewidth, trim=0cm 0cm 0cm 0cm]{./figures/fig2(b).pdf}}
...
\subfigure[Data throughput]{
	\includegraphics[width=0.48\linewidth, trim=0cm 0cm 0cm 0cm]{./figures/fig3.pdf}}
\subfigure[Number of valid data sessions]{
	\includegraphics[width=0.49\linewidth, trim=0cm 0cm 0cm 0cm]{./figures/fig4.pdf}}
