...
\subfigure[Movement from P-EGW1 to P-GEW2]{
	\includegraphics[width=0.47\linewidth, trim=0cm 0cm 0cm 0cm]{./figures/fig2(a).pdf}}
\subfigure[Movement from P-EGW2 to P-GEW3]{
	\includegraphics[width=0.50\linewidth, trim=0cm 0cm 0cm 0cm]{./figures/fig2(b).pdf}}
